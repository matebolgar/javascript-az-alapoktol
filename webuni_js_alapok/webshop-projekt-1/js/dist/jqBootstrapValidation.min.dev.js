...
!function (u) {
          ...
          u.each(n, function (a, t) {
            ...
            t.find("input,textarea,select").each(function (a, e) {
              ...
              if (u.each(u(e).triggerHandler("validation.validation", n), function (a, e) {
                o.push(e);
              }), o.length > t) u(e).attr("aria-invalid", "true");else {
  ...
  u.fn.jqBootstrapValidation = function (a) {
    return t.methods[a] ? t.methods[a].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != _typeof(a) && a ? (u.error("Method " + a + " does not exist on jQuery.jqBootstrapValidation"), null) : t.methods.init.apply(this, arguments);
