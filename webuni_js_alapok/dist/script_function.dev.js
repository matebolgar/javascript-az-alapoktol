...
susdMegARantottat();
console.log('-------------');
susdMegARantottat(); // function, matematikai függvény
...
console.log(addOne(addOne(addOne(5)))); // table lookup...
