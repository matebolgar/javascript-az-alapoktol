...
document.getElementById("element-four").onclick = function () {
  ...
  // timer indítása és a box megjelenítése 1 sec után
  setTimeout(function () {
...
document.getElementById("box-6").onsubmit = function (event) {
  ...
  for (const frmctrl of event.target.elements) {
